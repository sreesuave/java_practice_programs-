...
public class contact_rental_ex {
    public static void main(String[] args) {
        ...
        try {
        	...
        	min_bed.click();
        	WebElement max_bed = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[19]/td[2]/font/select/option[4]"));
        	max_bed.click();
        	WebElement min_bath = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[20]/td[2]/font/select/option[2]"));
        	min_bath.click();
        	WebElement max_bath = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[21]/td[2]/font/select/option[3]"));
        	max_bath.click();
        	WebElement pet = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[22]/td[2]/font/select/option[5]"));
        	pet.click();
        	WebElement smoker = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[24]/td/font/input[2]"));
        	smoker.click();
        	WebElement comments = driver.findElement(By.xpath("/html/body/div[3]/div[3]/form/table/tbody/tr/td/table/tbody/tr[26]/td/font/textarea"));
